...
import { CoordsUtils, incrementZoom, decrementZoom } from '@/src-isoflow/utils';
import { UiStateStore } from '@/src-isoflow/types';
...
const initialState = () => {
  return createStore<UiStateStore>((set, get) => {
    return {
      ...
      mouse: {
        position: { screen: CoordsUtils.coord(-1000, -1000), tile: CoordsUtils.coord(-1000, -1000) },
        mousedown: null,
        delta: null
      },
      itemControls: null,
